...
*/
$config['tables']['users']           = 'tb_auth_users';
$config['tables']['groups']          = 'tb_auth_groups';
$config['tables']['users_groups']    = 'tb_auth_users_groups';
$config['tables']['login_attempts']  = 'tb_auth_login_attempts';
